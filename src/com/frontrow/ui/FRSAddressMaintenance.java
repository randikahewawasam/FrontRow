   ...
   /* @Override
    ...
    /*				getParent().showDialog(Constants.SHOW_DIALOG);
    				...
    				bundle.putString(Constants.ERROR_D,
    						getResources().getString(R.string.DELETE_ADDRESS_MSG));
    				bundle.putString(Constants.TYPE, Constants.DELETE_ADDRESS_TYPE);
			...
			if(cRes.getResponseCode() == Constants.NETWORK_SUCCESS){
				...
				/*	Bundle bundle = new Bundle();
					...
					parentActivity.startChild("AddressList_Activity",
					 ...
					 contact.removeItemInAddressList(address,address.getIsPrimary());
					 finish();
				}
			}else{
				Bundle b = new Bundle();
